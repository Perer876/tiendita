...
class Ui_agregar_producto_window(object):
    def setupUi(self, agregar_producto_window):
        ...
        agregar_producto_window.resize(591, 430)
        icon = QIcon()
        ...
        self.agregar_pushButton = QPushButton(self.centralwidget)
        self.agregar_pushButton.setObjectName(u"agregar_pushButton")
        self.agregar_pushButton.setGeometry(QRect(190, 340, 93, 28))
        ...
        QWidget.setTabOrder(self.codigo_lineEdit, self.agregar_pushButton)
        QWidget.setTabOrder(self.agregar_pushButton, self.cancelar_pushButton)
    ...
    def retranslateUi(self, agregar_producto_window):
        ...
        self.cancelar_pushButton.setText(QCoreApplication.translate("agregar_producto_window", u"Cancelar", None))
        self.agregar_pushButton.setText(QCoreApplication.translate("agregar_producto_window", u"Agregar", None))
