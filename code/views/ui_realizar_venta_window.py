...
class Ui_realizar_venta_window(object):
    def setupUi(self, realizar_venta_window):
        ...
        icon4 = QIcon()
        icon4.addFile(u":/images/027-cart.png", QSize(), QIcon.Normal, QIcon.Off)
        self.eliminar_producto_pushButton.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/images/014-bookmark-5.png", QSize(), QIcon.Normal, QIcon.Off)
        self.disminuir_pushButton.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/images/019-bookmark.png", QSize(), QIcon.Normal, QIcon.Off)
        self.aumentar_pushButton.setIcon(icon6)
