...
class Ui_realizar_venta_window(object):
    def setupUi(self, realizar_venta_window):
        ...
        self.label_4.setGeometry(QRect(30, 540, 61, 41))
        self.total_label = QLabel(self.centralwidget)
        self.total_label.setObjectName(u"total_label")
        self.total_label.setGeometry(QRect(100, 540, 201, 51))
        self.frame_3 = QFrame(self.centralwidget)
        self.frame_3.setObjectName(u"frame_3")
        self.frame_3.setGeometry(QRect(10, 60, 1071, 91))
        self.frame_3.setFrameShape(QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QFrame.Raised)
        self.label_3 = QLabel(self.frame_3)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(20, 14, 101, 21))
        ...
        self.buscar_producto_por_comboBox.setGeometry(QRect(120, 10, 211, 31))
        ...
        self.termino_producto_lineEdit.setGeometry(QRect(350, 9, 511, 31))
        font = QFont()
        ...
        self.agregar_producto_pushButton.setGeometry(QRect(880, 10, 171, 31))
        icon1 = QIcon()
        ...
        self.busqueda_avanzada_pushButton = QPushButton(self.frame_3)
        self.busqueda_avanzada_pushButton.setObjectName(u"busqueda_avanzada_pushButton")
        self.busqueda_avanzada_pushButton.setGeometry(QRect(880, 50, 171, 31))
        icon2 = QIcon()
        icon2.addFile(u":/images/003-open-book-8.png", QSize(), QIcon.Normal, QIcon.Off)
        self.busqueda_avanzada_pushButton.setIcon(icon2)
        self.busqueda_avanzada_pushButton.setIconSize(QSize(25, 25))
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(30, 10, 1031, 41))
        ...
        icon3 = QIcon()
        icon3.addFile(u":/images/021-cart.png", QSize(), QIcon.Normal, QIcon.Off)
        self.finalizar_venta_pushButton.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/images/028-cart.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cancelar_pushButton.setIcon(icon4)
        self.cancelar_pushButton.setIconSize(QSize(50, 50))
        self.frame = QFrame(self.centralwidget)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(620, 530, 451, 51))
        self.frame.setFrameShape(QFrame.StyledPanel)
        self.frame.setFrameShadow(QFrame.Raised)
        self.eliminar_producto_pushButton = QPushButton(self.frame)
        self.eliminar_producto_pushButton.setObjectName(u"eliminar_producto_pushButton")
        self.eliminar_producto_pushButton.setGeometry(QRect(270, 10, 171, 31))
        icon5 = QIcon()
        icon5.addFile(u":/images/027-cart.png", QSize(), QIcon.Normal, QIcon.Off)
        self.eliminar_producto_pushButton.setIcon(icon5)
        self.eliminar_producto_pushButton.setIconSize(QSize(25, 25))
        self.disminuir_pushButton = QPushButton(self.frame)
        self.disminuir_pushButton.setObjectName(u"disminuir_pushButton")
        self.disminuir_pushButton.setGeometry(QRect(140, 10, 111, 31))
        icon6 = QIcon()
        icon6.addFile(u":/images/014-bookmark-5.png", QSize(), QIcon.Normal, QIcon.Off)
        self.disminuir_pushButton.setIcon(icon6)
        self.disminuir_pushButton.setIconSize(QSize(25, 25))
        self.aumentar_pushButton = QPushButton(self.frame)
        self.aumentar_pushButton.setObjectName(u"aumentar_pushButton")
        self.aumentar_pushButton.setGeometry(QRect(20, 10, 111, 31))
        icon7 = QIcon()
        icon7.addFile(u":/images/019-bookmark.png", QSize(), QIcon.Normal, QIcon.Off)
        self.aumentar_pushButton.setIcon(icon7)
    ...
    def retranslateUi(self, realizar_venta_window):
        ...
        self.busqueda_avanzada_pushButton.setText(QCoreApplication.translate("realizar_venta_window", u"Busqueda avanzada", None))
