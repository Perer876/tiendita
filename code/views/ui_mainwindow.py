...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_2 = QVBoxLayout(self.productos_tab)
        ...
        self.frame_2.setMinimumSize(QSize(514, 83))
        ...
        self.frame_3.setMinimumSize(QSize(1051, 51))
        ...
        self.buscar_producto_por_comboBox.setMinimumSize(QSize(120, 31))

        self.horizontalLayout_2.addWidget(self.buscar_producto_por_comboBox)
        ...
        self.termino_producto_lineEdit.setMinimumSize(QSize(220, 31))
        self.termino_producto_lineEdit.setClearButtonEnabled(True)

        self.horizontalLayout_2.addWidget(self.termino_producto_lineEdit)
        ...
        self.buscar_producto_pushButton.setMinimumSize(QSize(110, 31))
        icon4 = QIcon()
        ...
        self.horizontalLayout_2.addWidget(self.buscar_producto_pushButton)


        self.verticalLayout_2.addWidget(self.frame_3)

        self.frame_9 = QFrame(self.productos_tab)
        ...
        self.frame_9.setMinimumSize(QSize(1051, 300))
        self.frame_9.setFrameShape(QFrame.StyledPanel)
        self.frame_9.setFrameShadow(QFrame.Raised)
        self.verticalLayout_3 = QVBoxLayout(self.frame_9)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.productos_tableWidget = QTableWidget(self.frame_9)
        ...
        self.verticalLayout_3.addWidget(self.productos_tableWidget)


        self.verticalLayout_2.addWidget(self.frame_9)

        self.frame_8 = QFrame(self.productos_tab)
        self.frame_8.setObjectName(u"frame_8")
        self.frame_8.setMinimumSize(QSize(0, 51))
        self.frame_8.setFrameShape(QFrame.StyledPanel)
        self.frame_8.setFrameShadow(QFrame.Raised)
        self.cantidad_productos_label = QLabel(self.frame_8)
        self.cantidad_productos_label.setObjectName(u"cantidad_productos_label")
        self.cantidad_productos_label.setGeometry(QRect(230, 10, 1058, 33))
        self.label_4 = QLabel(self.frame_8)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(10, 10, 221, 31))
        ...
        self.menubar.setGeometry(QRect(0, 0, 1108, 26))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.editar_producto_pushButton.setText(QCoreApplication.translate("MainWindow", u"Editar productos", None))
